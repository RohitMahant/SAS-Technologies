...
export default function Home() {
  ...
  return (
    <div className="font-cocoRegular">
      ...
      <h1 className="text-center font-cocoBold md:mt-44 mt-16 md:text-2xl m-4">
        Your One-Stop Shop for Accessories
      </h1>
      <p className="text-center md:text-lg m-4">
 ...
 {/* New Section: Exclusive Brands */}
   ...
   <div className="w-full text-center mt-36">
        <h1 className="text-2xl md:text-5xl font-cocoBold">Exclusive Brands with Quality Products</h1>
        <p className="text-lg md:text-2xl mt-4">
        We take pride in offering a curated selection of products from industry-leading brands renowned for their exceptional durability, unmatched reliability, and superior quality. Each product is meticulously crafted to meet the highest standards, ensuring long-lasting performance and delivering unparalleled value to our customers.
        </p>
        {/* Infinite Logo Strip */}
        <div className="relative overflow-hidden mt-24">
          <div className="flex gap-12 animate-infinite-scroll">
            <img
              src="cp-plus.png"
              alt="CP Plus Logo"
              className="h-72 md:h-20 transition-transform duration-300 hover:scale-110"
            />
            <img
              src="Hikvision.svg"
              alt="Hikvision Logo"
      ...
      <div>
        <div className="md:mt-56 mt-12 m-6 ">
          <div className="w-full flex justify-center"><img src="logo.png" alt="logo" className=""/></div>
          <h1 className="text-center text-2xl md:text-5xl  font-cocoBold">
            Your Satisfaction, Our Mission
          </h1>
          <h1 className="text-center text-1xl md:text-4xl  font-cocoBold">
          Been in the business since <span className="font-bold font-serif text-2xl">2001</span>
          </h1>
          <p className="text-center  md:text-2xl m-4">
      ...
      <div className="md:mt-20 m-6 md:m-14">
        ...
        <div className="justify-center text-white items-center w-full md:flex mt-6">
          <button className="flex w-40 ml-[70px] h-10 justify-center  rounded-md bg-green-500 items-center gap-x-2">
            <IoIosCall size={25} color="white" className="" /> Give us a call
          </button>
          <br />
          <button className="flex justify-center ml-[70px]  items-center w-40 h-10 rounded-md gap-x-2 bg-gray-600 ">
